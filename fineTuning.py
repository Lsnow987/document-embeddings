...
#  below is the code i actually ran in colab - i think i made a few changes - not sure if they made the code better or worse - so im keeping both versions for now
...
df = pd.read_csv('test.csv',encoding_errors='ignore', quoting=3, engine='python')
# df['split'] = np.random.randn(df.shape[0], 1)
...
#we prob won't actually be using this because we already did a train,validation,test set split
train_size = 193913 # change for actual amount
test_size = 34219
